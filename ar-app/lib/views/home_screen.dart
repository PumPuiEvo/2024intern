...
import 'package:arapp/views/demo_code_page.dart';
    ...
    return Scaffold(
      ...
      body: Column(
        children: <Widget>[
          ...
          ElevatedButton(
              onPressed: () { Navigator.push(context, MaterialPageRoute(builder: (context) => const ArAppDemo())); },
              child: const Text("DemoCodePage")),
        ],
      ),
    );
  }
